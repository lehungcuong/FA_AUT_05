...
namespace XunitPOM.Pages
{
    public class BookingPage : BasePage
    {
        ...
        public void InputFlightTravellersInformation()
        {
            ...
            BrowserFactory.select(SelectMonthInDob, Utilities.SelectType.SELECT_BY_VALUE, "04");
            ...
            BrowserFactory.select(SelectTravellerInformationMonthOfIssuanceDate, Utilities.SelectType.SELECT_BY_VALUE, "01");
            ...
            BrowserFactory.select(SelectTravellerInformationMonthOfExpiryDate, Utilities.SelectType.SELECT_BY_VALUE, "01");
